...
class MainWindow(QtWidgets.QWidget):
    ...
    def get_mq_txt_dir(self):
        mq_txt_dir = QtWidgets.QFileDialog.getExistingDirectory(self, 'Open MaxQuant combined/txt folder' , '', QtWidgets.QFileDialog.ShowDirsOnly)
        self.mq_txt_dir_line_edit.setText(mq_txt_dir)
    
    def get_raw_dir(self):
        raw_dir = QtWidgets.QFileDialog.getExistingDirectory(self, 'Open folder with RAW files' , '', QtWidgets.QFileDialog.ShowDirsOnly)
    ...
    def run_simsi_transfer(self):
        ...
        simsi_transfer.main(['--mq_txt_folder', mq_txt_dir, '--raw_folder', raw_dir] + extra_params.split())
