...
integration_test_meta:
	python3 -um simsi_transfer --meta_input_file ${DATA}/meta_input_file.txt --output_folder ${DATA}/simsi_output --num_threads 3 --stringencies 20,15 --tmt_requantify ${EXTRA_ARGS}
